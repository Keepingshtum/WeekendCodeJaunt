...
class Facebook:
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        FPID=Facebook.get_access_token('FACEBOOK_PAGE_ID')
        FPAT=Facebook.get_access_token('FACEBOOK_PAGE_ACCESS_TOKEN')
        #req=requests.get(" ") This code might be useful for calling APIs
        #print(req.json)
        data = {
                'url': image_url,
                'published': 'true',
