...
# write your code below
    def publish_photo_msg( self,message, image_url):
        ...
        PPID=Pinterest.get_access_token('PINTEREST_BOARD_ID')
        PAT=Pinterest.get_access_token('PINTEREST_ACCESS_TOKEN')
        data = {
                'image_url': image_url,
                'access_token': PAT,
                'note' : message,
        ...
        response = requests.post('https://api.pinterest.com/v1/pins/?access_token=AtPAtFIonwBI5al3SqFzrzBgBjAmFekSco9jEr5GdKRNWwC41QtIwDAAAxE7RnSkj1Zgw1IAAAAA', data=data)
